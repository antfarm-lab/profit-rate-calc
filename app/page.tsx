...
export default function Home() {
  ...
  <div>
    <h2 className="text-2xl font-bold mb-3">
      利益率30%にするにはいくらで売ればいい？
    </h2>
    <p>
      商品を販売するときは、ただ利益が出ればいいわけではありません。
      継続して稼ぐためには利益率を意識することが重要です。
      利益率30%を目標にする場合、販売価格を逆算して決める必要があります。
    </p>
  </div>

  <div>
    <h2 className="text-2xl font-bold mb-3">
      利益率10%と30%ではどれくらい差が出る？
    </h2>
    <p>
      同じ10000円の商品でも、利益率10%なら利益1000円、
      利益率30%なら利益3000円になります。
      長期的に見ると利益率の差はかなり大きくなります。
      物販では利益額だけでなく利益率を見る習慣が大切です。
    </p>
  </div>
  ...
  <div>
    ...
    <p>
      月10万円売れていても利益率が5%なら利益は5000円しか残りません。
      売上だけを見るのではなく、
      実際にどれくらい利益が残るのか確認することが重要です。
      利益率を把握することで、効率よく収益を伸ばしやすくなります。
    </p>
  </div>
  ...
  <div>
    ...
    <p>
      Q. フリマアプリ販売にも使えますか？<br />
      A. はい。仕入れ値や販売価格から利益率確認に使えます。<br /><br />

      Q. 物販ビジネス全般でも使えますか？<br />
      A. はい。EC販売やネットショップの利益率確認にも使えます。
    </p>
  </div>
